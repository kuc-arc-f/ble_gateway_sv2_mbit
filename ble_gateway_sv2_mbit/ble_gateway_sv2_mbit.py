#
# raspberryPi, ble_gateway_sv2_mbit (micro:bit  )
# version : 0.9.3
# date : 2017/10/02
#
...
def send_http(clsDat):
	...
	if (len(sV1 ) > 0 ):
		sReq +="&field1=" + str(sV1)
#	sV2=clsDat.get_datByName("device1" , 2)
#	if (len(sV2 ) > 0 ):
#		sReq +="&field2=" + str(sV2)
	sV2b=clsDat.get_datByName("device2" , 1 )
	if (len(sV2b ) > 0 ):
	...
	if (len(sV4 ) > 0 ):
		sReq +="&field5=" + str(sV4 )
	sV6=clsDat.get_datByName("device21" , 1 )
	if (len(sV6 ) > 0 ):
		sReq +="&field6=" + str(sV6 )
	sV7=clsDat.get_datByName("device21" , 2 )
	if (len(sV7 ) > 0 ):
		sReq +="&field7=" + str(sV7 )
